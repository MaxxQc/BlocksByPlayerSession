...
public class Yaml {
	...
	public ConfigurationSection getConfigurationSection(String string) {
		return this.yaml.getConfigurationSection(string);
	}

	public ConfigurationSection createConfigurationSection(String string) {
		return this.yaml.createSection(string);
	}

	public List<?> getList(String string) {
		return this.yaml.getList(string);
	}
}