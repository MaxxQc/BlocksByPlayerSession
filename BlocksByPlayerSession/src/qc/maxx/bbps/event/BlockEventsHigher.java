...
public class BlockEventsHigher implements Listener {
	public BlockEventsHigher(BBPSPlugin plugin) {
	...
	public void onPlayerBreakBlock(BlockBreakEvent e) {
		...
		if (ConfigHandler.blocksChangeLimit > 0) {
			...
			if (p != null && !p.getChangedBlocks().contains(Util.correctLocation(e.getBlock().getLocation()))) {
				...
				} else if (e.getBlock().getType() == Material.WOODEN_DOOR || e.getBlock().getType() == Material.SPRUCE_DOOR || e.getBlock().getType() == Material.DARK_OAK_DOOR
						|| e.getBlock().getType() == Material.BIRCH_DOOR || e.getBlock().getType() == Material.ACACIA_DOOR || e.getBlock().getType() == Material.JUNGLE_DOOR
						|| e.getBlock().getType() == Material.IRON_DOOR_BLOCK) {
